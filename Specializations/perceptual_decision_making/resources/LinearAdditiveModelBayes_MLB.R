...
## Perceptual decisions tournament. This script will fit the most basic model that just contains a linear transducer and assumes additive internal noise (with a value set to 1). This script demonstrates fitting the model in a (multi-level) Bayesian way.
...
nChains<-4
monparms<-c("beta","mu_beta","tau_beta") # Which parameters to monitor?
lam_mcmc<-jags(jList, parameters.to.save=monparms,
                 model.file ="lamJAGS_MLB.j", n.chains=nChains, n.iter=5000,
